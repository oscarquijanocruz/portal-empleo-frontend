...
export default function NotificacionesPage() {
  ...
  const notificationCounts = useMemo(() => {
    const counts = {
      ...
      job_application: notifications.filter(n => n.type === "job_application").length,
  ...
  const filteredNotifications = useMemo(() => {
    ...
    if (searchTerm) {
      ...
      filtered = filtered.filter(n => 
        ...
        (n.metadata?.jobTitle && n.metadata.jobTitle.toLowerCase().includes(term)) ||
        (n.metadata?.company && n.metadata.company.toLowerCase().includes(term)) ||
        (n.metadata?.candidateName && n.metadata.candidateName.toLowerCase().includes(term))
      );
    }
  ...
  return (
    <div className="h-full flex flex-col bg-gray-50">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                {notificationCounts.unread} no leídas de {notificationCounts.total} total
              </p>
            </div>
          </div>
      ...
      <div className="w-12 flex-1 flex flex-col">
        {/* Filtros */}
        <div className="p-4">
         <Button className="flex w-full h-10">
